...
- Chrome package: C:\xampp\htdocs\filescanner\dist\grab-all-files-chrome-v4.5.7.zip
- Edge package: C:\xampp\htdocs\filescanner\dist\grab-all-files-edge-v4.5.7.zip
- Firefox package: C:\xampp\htdocs\filescanner\dist\grab-all-files-firefox-v4.5.7.zip
...
- Confirm the submitted package version is 4.5.7.
...
- Firefox/AMO may request source code for review. The v4.5.7 source ZIP is available at C:\xampp\htdocs\filescanner\grab-all-files-source-v4.5.7.zip and is verified to reproduce dist/firefox byte-for-byte via npm install + npm run build.
