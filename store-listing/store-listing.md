...
- Chrome package: C:\xampp\htdocs\filescanner\dist\grab-all-files-chrome-v5.1.2.zip
- Edge package: C:\xampp\htdocs\filescanner\dist\grab-all-files-edge-v5.1.2.zip
- Firefox package: C:\xampp\htdocs\filescanner\dist\grab-all-files-firefox-v5.1.2.zip
...
- Confirm the submitted package version is 5.1.2.
...
- Firefox/AMO may request source code for review. The v5.1.2 source ZIP is available at C:\xampp\htdocs\filescanner\grab-all-files-source-v5.1.2.zip and is verified to reproduce dist/firefox byte-for-byte via npm install + npm run build.
